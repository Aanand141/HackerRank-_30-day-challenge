...
/*
 * Day 21: Generics | 30 Days Of Code |
 * Objective
 * Today we’re discussing Generics; be aware that not all languages support this
 * construct, so fewer languages are enabled for this challenge.
 * 
 * Task
