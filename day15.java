 ...
 * parameters: a pointer, head, pointing to the first node of a linked list, and
 * an integer, data, that must be added to the end of the list as a new Node
 * object.
 * 
 * Task
 ...
 * Each of the next T lines contains an integer to insert at the end of the
 * list.
 * 
 * Output Format
 ...
 * First the code returns a new node that contains the data value 2 as the head
 * of the list. Then create and insert nodes 3, 4, and 1 at the tail of the
 * list.
 */
import java.io.*;
import java.util.*;
