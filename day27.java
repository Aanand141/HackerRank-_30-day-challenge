 ...
 * element with the minimum value, it returns the smallest one.
 ...
 * return values. Finish the implementation of classes to provide data and
 ...
 * 
 * get_array() returns an array where the minimum value occurs at exactly 2
 * indices
